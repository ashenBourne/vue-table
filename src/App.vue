 ...
 * @LastEditTime: 2020-07-29 10:11:17
-->
<template>
  <div id="app">
    ...
    >
      <el-table-column label="操作" width="240" align="center">
        <template slot-scope="{ row }">
          <el-button size="small" type="text" @click="fileManage(row)"
            >文件管理</el-button
          >
          <el-button size="small" type="text" @click="getProjectInfo(row)"
            >项目信息</el-button
          >
          <el-button
            size="small"
            type="text"
            @click="deleteRow(row, deleteSure, '是否删除此项目')"
            >删除</el-button
          >
        </template>
      </el-table-column>
